...
class ModelWrapper:
    ...
    def train_evaluate_and_save_model(
        ...
        self.model.save(f"artifacts/models/{self.model_name}.h5")
        print("Model saved successfully!")

    def load_model(self, model_path: Union[str, None]):
        if model_path is None:
            model_path = f"artifacts/models/{self.model_name}.h5"
    ...
    def plot_accuracy(self):
        ...
        plt.xlabel("Epoch")
        plt.legend(loc="best")
        plt.savefig(f"artifacts/plots/Accuracy_{self.model_name}")
        plt.show()
    ...
    def plot_loss(self):
        ...
        plt.xlabel("Epoch")
        plt.legend(loc="best")
        plt.savefig(f"artifacts/plots/Loss_{self.model_name}")
        plt.show()
    ...
    def display_confusion_matrix(self):
        ...
        plt.savefig(f"artifacts/metrics/ConfusionMatrix_{self.model_name}.png")
        plt.show()
